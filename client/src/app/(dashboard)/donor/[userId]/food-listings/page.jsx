              ...
              {listings.map((listing) => (
                ...
                >
                  {listing.imageUrl ? (
                    ...
                    <div className="sm:w-40 h-24 sm:h-auto flex-shrink-0 bg-gray-100 flex items-center justify-center text-3xl">
                      🍽️
                    </div>
                  )}
                  <div className="flex-1 p-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span
                        className={`text-xs font-medium px-2 py-1 rounded-full flex-shrink-0 ${STATUS_COLORS[listing.status] || "bg-gray-100 text-gray-600"}`}
                      >
                        {listing.status}
                      </span>
                    </div>
              ...
              {pendingRequests.length > 0 && (
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs font-medium px-2 py-1 rounded-full flex-shrink-0 ${REQUEST_STATUS_COLORS[req.status] || "bg-gray-100 text-gray-600"}`}
                    >
                      {req.status}
                    </span>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid gap-3">
                    {reviewedRequests.map((req) => (
                      <div
                        key={req.id}
                        className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 opacity-80"
                      >
