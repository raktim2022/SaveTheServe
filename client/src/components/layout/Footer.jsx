        ...
        <div className="grid gap-12 py-16 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            <Link href="/" className="inline-flex items-center gap-3 group">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Food rescue and community distribution network
                </p>
              </div>
            </Link>

            <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
              SaveTheServe helps restaurants, donors, and NGOs move surplus food
              to communities with speed, traceability, and dignity. We focus on
              reliable coordination, transparent reporting, and measurable
              impact.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-3 text-sm text-slate-300 leading-6">
                  Operational in partner cities with route-based pickup
                  coordination and NGO verification.
                </p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
                ...
                <p className="mt-3 text-sm text-slate-300 leading-6">
                  Secure payments, verified partners, and clear audit trails
                  across every donation workflow.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.18)]">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-white">
              Get operational updates and impact stories
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-300">
              Receive important platform updates, product releases, and
            ...
            <div className="mt-5 flex gap-2">
              ...
              <Button
                size="sm"
                className="rounded-xl bg-linear-to-r from-emerald-500 to-teal-600 px-4"
              >
            ...
            <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">
              No spam. Only essential updates and service announcements.
            </p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">
                  Professional and secure by design
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  We maintain a clear privacy posture, secure checkout
                  integration, and accessible flows for donors, NGOs, and
        ...
        <div className="flex flex-col gap-4 border-t border-white/10 py-8 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-medium text-slate-300">
              © {currentYear} SaveTheServe. All rights reserved.
            </p>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Built for food rescue, donor trust, and verified community impact.
            </p>
          </div>
