    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
      ...
      {details && (
        <div className="space-y-3 mb-4 text-sm">
          <div>
            <span className="text-gray-600 dark:text-slate-300">Organization Name:</span>
            <span className="ml-2 font-medium">{details.name}</span>
          </div>

          {details.registrationNumber && (
            <div>
              <span className="text-gray-600 dark:text-slate-300">Registration Number:</span>
          ...
          {details.description && (
            <div>
              ...
              <p className="mt-1 text-gray-700 dark:text-slate-200">{details.description}</p>
            </div>
          )}

          <div>
            <span className="text-gray-600 dark:text-slate-300">Registered:</span>
