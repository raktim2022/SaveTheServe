  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-500 dark:from-emerald-900 dark:to-emerald-800 rounded-2xl p-6 text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-100 text-sm">
                Volunteer at{' '}
                <strong>{profile?.ngo?.ngoName || 'your NGO'}</strong>
              </p>
            </div>
          </div>
          {/* Settings shortcut for verified users */}
        ...
        {/* Only show verification indicators when there are pending steps */}
        {(mustChangePassword || !phoneVerified) && (
          <div className="mt-4 flex items-center gap-4 text-sm">
            <div className="flex items-center gap-1.5">
              <AlertCircle className="h-4 w-4 text-yellow-300" />
              <span className="text-yellow-200">Phone Not Verified</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Shield className="h-4 w-4 text-green-200" />
              <span className="text-green-100 capitalize">{profile?.status || 'Pending'}</span>
            </div>
          </div>
        )}
      </div>
